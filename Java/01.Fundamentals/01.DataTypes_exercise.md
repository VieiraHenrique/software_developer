...
I'd like you to have at least one : `int`, `short`, `long` `float`, `byte`, `boolean`, `char` and `String`.

<details>
<summary>Open after completion
</summary>

- **seller** is a string of characters. The only data type that can hold this is `String`.
